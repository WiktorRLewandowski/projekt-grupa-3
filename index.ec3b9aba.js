 ...
 * limitations under the License.
 */
const G=1e3,Z=2,J=144e5,Y=.5;function X(e,t=G,n=Z){const r=t*Math.pow(n,e),a=Math.round(Y*r*(Math.random()-.5)*2);return Math.min(J,r+a)}
/**
 * @license
 ...
 * limitations under the License.
 */
const qe="firebase-heartbeat-database",Ke=1,Ge="firebase-heartbeat-store";let Ze=null;function Je(){return Ze||(Ze=Ce(qe,Ke,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Ge)}}).catch((e=>{throw He.create("idb-open",{originalErrorMessage:e.message})}))),Ze}async function Ye(e,t){try{const n=(await Je()).transaction(Ge,"readwrite"),r=n.objectStore(Ge);await r.put(t,Xe(e)),await n.done}catch(e){if(e instanceof U)Me.warn(e.message);else{const t=He.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Me.warn(t.message)}}}function Xe(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gt="firebase-installations-database",Zt=1,Jt="firebase-installations-store";let Yt=null;function Xt(){return Yt||(Yt=bt(Gt,Zt,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Jt)}})),Yt}async function Qt(e,t){const n=Ht(e),r=(await Xt()).transaction(Jt,"readwrite"),a=r.objectStore(Jt),i=await a.get(n);return await a.put(t,n),await r.done,i&&i.fid===t.fid||Ut(e,t.fid),t}async function en(e){const t=Ht(e),n=(await Xt()).transaction(Jt,"readwrite");await n.objectStore(Jt).delete(t),await n.done}async function tn(e,t){const n=Ht(e),r=(await Xt()).transaction(Jt,"readwrite"),a=r.objectStore(Jt),i=await a.get(n),o=t(i);return void 0===o?await a.delete(n):await a.put(o,n),await r.done,!o||i&&i.fid===o.fid||Ut(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
//# sourceMappingURL=index.ec3b9aba.js.map
